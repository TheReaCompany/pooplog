...
function sfc_comm_login_button() {
	echo '<p><fb:login-button v="2" onlogin="sfc_update_user_details();"><fb:intl>Connect with Facebook</fb:intl></fb:login-button></p>';
}
