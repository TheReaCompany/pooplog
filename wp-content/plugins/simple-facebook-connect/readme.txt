...
= What does this SFC-Connect widget plugin do? =

Nothing, really. It shows a connect button in the sidebar. That's it. It doesn't do anything special when you connect using it. It's a demonstration, nothing more. It's probably not useful on any real website.
...
= 0.14 =
* Fixes error in fanbox in 0.13.
* Fixes error with publish plugin if your theme doesn't support thumbnails.
...
* Fixes error with publish plugin if your theme doesn't support thumbnails.
* Publish privacy setting doesn't work for some people, removed.
