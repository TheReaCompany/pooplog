		...
		<?php unset ( $language ); ?>
				...
				<table id="sbadvanced" class="form-table">
					...
					<tr valign="top">
						...
						<td>
							<textarea name="shadowbox[flashParams]" rows="10" cols="50"><?php echo wp_htmledit_pre ( $this->get_option ( 'flashParams' ) ); ?></textarea>
							<br />
					...
					<tr valign="top">
						...
						<td>
							<textarea name="shadowbox[flashVars]" rows="10" cols="50"><?php echo wp_htmledit_pre ( $this->get_option ( 'flashVars' ) ); ?></textarea>
							<br />
