<div class="wrap">
    ...
    <form name="s3settings" method="post" action="options.php">
     ...
     <p><span style="font-weight:bold;">AMAZON S3 FAQs</span> : <a href="http://aws.amazon.com/s3/faqs/#How_can_I_get_started_using_Amazon_S3">Click Here</a></p> 
      ...
      <p class="alignleft" style="width:300px; text-align:center; border:1px solid #404040; padding:2px">If you enjoy using this plugin, please consider making a monetary donation.  It will help with upkeep and improvements to this plugin!  </p><br /> <p class="alignright"> <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
